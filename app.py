...
if page == "🏠 Dashboard":
    ...
    from views import medication; medication.show()
elif page == "🏃 Fitness & Diet":
    from views import fitness; fitness.show()
elif page == "🤖 Health Chatbot":
    from views import chatbot; chatbot.show()
elif page == "📊 Health Reports":
    from views import reports; reports.show()
